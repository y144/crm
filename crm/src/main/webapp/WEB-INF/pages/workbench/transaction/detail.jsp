...
<script type="text/javascript">
	...
	$(function(){
		...
		/*通过on 来绑定就是一种动态的绑定备注的修改跟删除，能进行实时的刷新  效果*/
		...
		$("#saveCreateRemarkBtn").click(function () {
			...
			//发送请求
			$.ajax({
				url:'workbench/clue/saveCreateTranRemark.do',
				data:{
				...
				success:function (data) {
					if (data.code=="0"){
						...
						htmlStr+="<font color=\"gray\">线索</font> <font color=\"gray\">-</font> <b>${tran.name}</b> <small style=\"color: gray;\"> "+data.retData.createTime+" 由${sessionScope.sessionUser.name}创建</small>";
		...
		<c:forEach items="${remarkList}" var="remark">
			<div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">线索</font> <font color="gray">-</font> <b>${tran.name}</b> <small style="color: gray;"> ${remark.editFlag==0?remark.createTime:remark.editTime} 由${remark.editFlag==0?remark.createBy:remark.editBy}${remark.editFlag==0?'创建':'修改'}</small>
